 ...
 */
export function PredictionCard({ stockSymbol, stockPriceUsd }: { stockSymbol: string; stockPriceUsd: number }) {
  ...
  return (
    <section className="card predict" aria-label="Launch a prediction market">
      ...
      <p>A yes/no market on {stockSymbol}, settled by Squidlor's oracle.</p>
